...
arr_dockerregistry+=( 
    ["ascore"]=gcr.io/motrpac-portal-dev/motrpac-prot-ascore
    ["masic"]=gcr.io/motrpac-portal-dev/motrpac-prot-masic
    ["msgfplus"]=gcr.io/motrpac-portal-dev/motrpac-prot-msgfplus
    ["mzid2tsv"]=gcr.io/motrpac-portal-dev/motrpac-prot-mzid2tsv
    ["phrp"]=gcr.io/motrpac-portal-dev/motrpac-prot-phrp 
    ["ppmerror"]=gcr.io/motrpac-portal-dev/motrpac-prot-ppmerror 
)
